...
Given one data point \(t_a\), the travel time function \(tt_a\) and the probability density functions for the parameters \(\beta, \gamma, t^*\),
...
The first insight from doing this procedure concerns the parameter \(\sigma\):
...
\begin{figure}
  \centering
  \includegraphics[width=.7\textwidth]{contour_beautiful}
...
\begin{figure}
  \centering
  \includegraphics[width=.7\textwidth]{contour_ugly}
...
The reason behind this phenomenon is quite intuitive:
...
\begin{figure}
  \centering
  \includegraphics[width=.7\textwidth]{contour_flat}
...
While these values could appear not extremely encouraging,
...
\begin{figure}
  \centering
  \includegraphics[width=.4\textwidth]{hyp}
...
\begin{figure}
  \centering
  \includegraphics[width=.7\textwidth]{tdata_f}
...
\begin{figure}
  \centering
  \includegraphics[width=.7\textwidth]{hist_data}
...
Recall now that, in the simplest case, two groups of users are simulated:
