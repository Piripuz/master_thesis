...
Given one data point \(t_a\), the travel time function \(tt_a\) and probability density functions for the parameters \(\beta, \gamma, t^*\),
...
The first insight from doing this procedure regards the parameter \(\sigma\):
