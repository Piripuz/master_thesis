...
Extensive work has been done to estimate the values of these parameters:
...
The estimation of these parameters has anyway always been based on survey data or,
...
and some of these weaknesses are highlighted in \parencite{54d203ee-4bf8-3234-9286-56e4c8b7f5bd}:
