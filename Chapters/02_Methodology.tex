...
(as in \cite{pathak2024randomizedgridsearchhyperparametertuning,poÅ¡tuvan2022adagridadaptivegridsearch}),
...
\begin{figure}
  ...
  \begin{tikzpicture}
    ...
    \draw (n3.south) -- (x) edge node[midway,align=center] {Forecasted\\Network\\Conditions} (y) (y) edge[->] (in);
  \end{tikzpicture}
