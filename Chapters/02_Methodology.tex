...
\todo{Maybe it makes sense to postpone the concept presented in the introduction after the next section, and have a more general intro here}
After that, I will return to the distinction above and choose the method that is the most suitable for doing the estimation.
...
In the following lines, different methods to address this question are presented.
