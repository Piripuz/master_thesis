...
slopes computed using real data are indeed much lower than what one would expect from theoretical studies on Vickrey's model at equilibrium\todo{As shown in figure...}.
