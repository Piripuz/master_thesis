...
computing the likelihood will indeed require computations that can only be computationally approximated,
...
and present some solutions that can help in mitigating the issues.
