...
These works were later extended, taking into account more complex network: initially, \textcite{doi:10.1287/trsc.24.3.217} considers a Y-shaped network,
...
They develop a method that allows to analytically find equilibrium solution for bigger networks,
with an arbitrary number of bottlenecks.

Similarly to how increasingly complex network have been studied,
...
They show that the slope of the travel time function gradually increase when getting closer to the desired arrival time,
