...
\usepackage[backend=biber,style=authoryear-comp,sorting=none]{biblatex} % Package for bibliography (citing)
...
\setlength{\marginparwidth}{2cm} % Remove me as well, only for todonotes
